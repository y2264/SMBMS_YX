...
<div class="right">
    ...
    <div class="search">
        <form method="get" action="${pageContext.request.contextPath }/UserServlet/query">
            ...
            <input value="查 询" type="submit" id="searchbutton" style="width: auto">
            <input value="删 除" type="submit" class="deleteUser" style="width: auto">
    ...
    <table class="providerTable" cellpadding="0" cellspacing="0">
        ...
        <c:forEach var="user" items="${userList}" varStatus="status">
            <tr>
                <th><input type="checkbox" name="userIds" value="${user.id}"></th>
                <td>
